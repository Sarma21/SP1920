...
public class SensorController {
  ...
  static Motion forWard, sideStepRight, turnLeft, turnLeft60, turnLeft180, handWave, anfall, up, bauch;
 ...
 public static void loadMotionFiles(){
   ...
   */
   ...
   static void move() {
     ...
     boolean check2 = false;  //Prüft ob eine linksdrehung bereits stattgefunden hat.
     ...
     for (sensor = 0; sensor < 2; sensor++) {
       ...
       if (check2){
         System.out.println("turnLeft180");
         startMotion(turnLeft180);
         check = false; 
         break;
       }
